            ...
            <div class="h-screen">
                <div class="d-flex align-center" style="height: 100vh;">
                    ...
                    <v-card class="mx-auto pa-lg-12 pb-8 pa-6 register_card" elevation="8" max-width="448"
                        ...
                        <v-form @submit.prevent="register_user" lazy-validation v-model="valid">
                            <div class="text-h5 font-weight-bold">Create an Account</div>
                            <div class="text-body-2 mb-3"> Make the most of your digital life </div>
                            ...
                            <p class="text-medium-emphasis text-caption text-center"> By clicking Agree & Join or
                                Continue, you agree to the User Agreement, Privacy Policy, and Cookie Policy. </p>
                            ...
                            <v-card-text class="text-center">
                                <a class="text-black text-decoration-none">
                                    Already on OurApp? <RouterLink to="/" class="text-decoration-none"> <span class="text-blue text-decoration-none">Sign in</span>
                                    </RouterLink>
                                </a>
                            </v-card-text>
                        </v-form>
    ...
    if ((email != '') || (password != '')) {
        createUserWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                if (user) {
                    const custom_msg = 'Account Registered Successfully';
